...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" integrity="sha384-k6RqeWeci5ZR/Lv4MR0sA0FfDOM3RzR+fY4ZFx5ZZlIhF8R6L0X9qA1nd6n3+5w" crossorigin="anonymous">
    ...
    <script src="<?= base_url('asset/js/idle-handler.js') ?>"></script>
</head>

    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <!-- Profile -->
                <li class="nav-item">
                    <a href="<?= base_url('User/cKelolaData/profil') ?>"
                ...
                <!-- Dashboard -->
                <li class="nav-item">
                    <a href="<?= base_url('User/cDashboard') ?>"
                ...
                <!-- Data Master -->
                        <li class="nav-item">
                            <a href="<?= base_url('User/cKelolaData/tablet') ?>"
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('User/cKelolaData/pegawai') ?>"
                ...
                <!-- Transaksi -->
                <li class="nav-item">
                    <a href="<?= base_url('User/cKelolaData/transaksi') ?>"

    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <!-- Profile -->
                <li class="nav-item">
                    <a href="<?= base_url('Admin/cKelolaData/profil') ?>"
                ...
                <!-- Data Master -->
                        <li class="nav-item">
                            <a href="<?= base_url('Admin/cKelolaData/tablet') ?>"
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Admin/cKelolaData/pegawai') ?>"
                ...
                <!-- Transaksi -->
                <li class="nav-item">
                    <a href="<?= base_url('Admin/cKelolaData/transaksi') ?>"
